...
class Node:
    ...
    def __eq__(self, other):
        return other is not None and self.top(other)
...
class Block:
    ...
    def __eq__(self, other):
        ...
        return other is not None and ((self.A == other.A and self.B == other.B) or (self.A == other.B and self.B == other.A))
        ...
        if (block.weight() == 2 and self.w == 2) or self.w == 1:
            ...
            if self.type == TOGGLEBTN:
                ...
                for i in self.lsHide:
                    i.hide()
                return True
            elif self.type == SHOWANDTOG:
                for i in self.lsShow:
                    i.show()
                for i in self.lsPoint:
                    i.toggle()
                return True
        ...
        if (block == None):
            ...
            try:
                if block.weight() == 1:
                    ...
                    mapWithBlock[block.A.x][block.A.y] = Node("#", block.A.x, block.A.y)
